...
export function buildHelpCard(
  ...
  const lines = [
    ...
    "发送 **/new mimo** 创建新 MiMo Code 会话",
    "发送 **/new deveco** 创建新 Deveco Code 会话",
  ...
  return JSON.stringify({
    ...
    elements: [
      ...
      buildButtons([
        ...
        { text: "新建 MiMo Code 会话（/new mimo）", value: JSON.stringify({ cmd: "new mimo" }), type: "primary" },
        { text: "新建 Deveco Code 会话（/new deveco）", value: JSON.stringify({ cmd: "new deveco" }), type: "primary" },
